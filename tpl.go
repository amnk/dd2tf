...
func tmplMonitorTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/monitor.tmpl", size: 1512, mode: os.FileMode(420), modTime: time.Unix(1557777195, 0)}
...
func tmplScreenboardTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/screenboard.tmpl", size: 8376, mode: os.FileMode(420), modTime: time.Unix(1557777163, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func tmplTimeboardTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/timeboard.tmpl", size: 2261, mode: os.FileMode(420), modTime: time.Unix(1557777163, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
